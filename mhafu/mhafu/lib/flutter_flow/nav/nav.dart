        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'FoodNutrients1',
              path: 'foodNutrients1',
              builder: (context, params) => FoodNutrients1Widget(),
            ),
            FFRoute(
              name: 'FoodNutrients2',
              path: 'foodNutrients2',
              builder: (context, params) => FoodNutrients2Widget(),
            ),
            FFRoute(
              name: 'UpdateWeight',
              path: 'updateWeight',
              builder: (context, params) => UpdateWeightWidget(),
            ),
            FFRoute(
              name: 'goal',
              path: 'goal',
            ...
            FFRoute(
              name: 'Updategoal',
              path: 'updategoal',
              builder: (context, params) => UpdategoalWidget(),
            ),
            FFRoute(
              name: 'BMI',
              path: 'bmi',
              builder: (context, params) => BmiWidget(
                ...
                height: params.getParam('height', ParamType.double),
              ),
            )
