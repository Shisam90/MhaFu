...
import 'api/blocs/recommended_one_cubit/recommended_one_cubit.dart';
import 'api/models/recommendation_one_model.dart';

class RecommendatoionResultPage extends StatelessWidget {
  const RecommendatoionResultPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<RecommendedOneCubit, RecommendedOneState>(
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: const Text("Your Dietary Plan"),
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  _RecepieDescription(mealType: "Lunch", meal: launch),
                  const Divider(color: Colors.grey, thickness: 2),
